...
pub use volume::{
    ...
    DirectoryNodeId, DurableMutation, EpochReadOperation, EpochReadPass, EpochSequence,
    ExternalJournalProbeOperation, ExternalJournalProbeOutcome, ExternalJournalProbeTransition,
    ExternalJournalRequirement, FileNode, FileNodeId, HardLinkDestination, HardLinkEntry,
    HardLinkNodeId, HardLinks, HomeBlockDurability, JournalPayloadDurability, MountOperation,
    ...
    TransactionHardLinkSource, TransactionNode, TransactionSymlink, ValidatedExternalJournal,
    VisibilityLease, VolumeGeometry, VolumeIdentity,
};

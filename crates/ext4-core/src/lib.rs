...
pub use volume::{
    ...
    MutationResource, NodeId, NodeMetadataSnapshot, NodeReparsePoint, ObservedResourceVersionSet,
    OperationEvent, OperationId, OrderedDataDurability, PublishedMutation, ReadTransition,
    RenameTargetCollision, ReservedMutation, ResolvedMutation, ResourceVersion, RetryPermit,
    ScannedDirectoryEntry, StorageRequestSequence, StorageRequestSequenceStep, SymlinkNode,
    ...
    VolumeIdentity, WindowsNameMatch,
};

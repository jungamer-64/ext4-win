...
pub(crate) use wdk_sys::ntddk::{
    ...
    IoGetTopLevelIrp, IoQueueWorkItem, IoRegisterShutdownNotification, IoReleaseVpbSpinLock,
    IoSetCompletionRoutineEx, IoSetTopLevelIrp, IoUnregisterShutdownNotification, IofCallDriver,

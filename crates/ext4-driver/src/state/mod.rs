...
impl DeviceExtensionHeader {
    ...
    unsafe fn retire(&self) -> ReactorTarget {
...
impl ControlDeviceLifecycle {
    ...
    fn state(&self) -> ControlDevicePhase {
    ...
    fn begin_retirement(&self) -> DriverResult<RetirementAdmission> {

...
use wdk_sys::{
    ...
    STATUS_INVALID_DEVICE_REQUEST, STATUS_NOT_IMPLEMENTED, STATUS_SUCCESS,
};
...
unsafe extern "C" fn write(_device: PDEVICE_OBJECT, _irp: PIRP) -> NTSTATUS {
    STATUS_NOT_IMPLEMENTED
}
...
unsafe extern "C" fn set_information(_device: PDEVICE_OBJECT, _irp: PIRP) -> NTSTATUS {
    STATUS_NOT_IMPLEMENTED
}
...
unsafe extern "C" fn set_volume_information(_device: PDEVICE_OBJECT, _irp: PIRP) -> NTSTATUS {
    STATUS_NOT_IMPLEMENTED
}
...
unsafe extern "C" fn set_security(_device: PDEVICE_OBJECT, _irp: PIRP) -> NTSTATUS {
    STATUS_NOT_IMPLEMENTED
}
